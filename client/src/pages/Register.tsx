...
export default function Register() {
  ...
  const handleRegister = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (role !== 'admin') {
        payload.staffId = staffId.toUpperCase();
      }
      ...
      <div className="flex-1 p-8 md:p-20 flex items-center justify-center">
        <div className="w-full max-w-lg space-y-10">
          ...
          <form onSubmit={handleRegister} className="space-y-6">
            ...
            <div className="space-y-1">
              <Label className="font-mono uppercase text-[10px] tracking-widest text-deep-black/60 ml-1">Staff ID (Generated by Admin) - Required for Waiter/Cashier</Label>
              <Input
                type="text"
                value={staffId}
